		...
		<main class="main">
			...
			<div class="search-form margin-top first align-right">
				...
				<form class="table-form">
					<fieldset>
						...
						<select name="f">
							<option <c:if test="${param.f eq 'title'}"> selected </c:if> value="title">제목</option>
							<option <c:if test="${param.f eq 'writer_id'}"> selected </c:if> value="writer_id">작성자</option>
						</select> 
			...
			<div class="margin-top align-center pager">	
				...
				<ul class="-list- center">
					...
					<li><a class="-text- ${(page==(startNum+i))?'orange':''} bold" href="?p=${startNum+i}&t=&q=" >${startNum+i}</a></li>					
					</c:if>
					</c:forEach>
